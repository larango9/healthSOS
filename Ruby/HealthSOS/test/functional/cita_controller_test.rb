...
class CitaControllerTest < ActionController::TestCase
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post :create, citum: { cedulaDoctor: @citum.cedulaDoctor, cedulaPaciente: @citum.cedulaPaciente, fecha: @citum.fecha }
    end
  ...
  test "should update citum" do
    put :update, id: @citum, citum: { cedulaDoctor: @citum.cedulaDoctor, cedulaPaciente: @citum.cedulaPaciente, fecha: @citum.fecha }
    assert_redirected_to citum_path(assigns(:citum))
  end
