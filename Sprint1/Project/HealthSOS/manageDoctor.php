            ...
            <div style="text-align:centert">
                <div style="text-align: justify">
                    ...
                    <div class="container">
                        ...
                        echo "<tr>
                            <th colspan=10 align=center> Tabla General Medico </th>
                            <tr>
                            <th> Id </th><th> Num Cedula </th><th> Contraseña </th><th> Nombre </th> 
                            <th> Apellido </th><th> Profesión </th><th> Fecha Nacimiento </th>
                            <th> Email </th><th> Num Celular </th><th> Consultorio </th>
                            </tr>";
                        /* Y ahora todos los registros */
                        while ($row = mysqli_fetch_array($result)) {
                            echo "<tr>
                                <td align='right'> $row[id_doctor] </td>
